...
SECRET_KEY = 'django-insecure-f5$ma-6m%t067fdf(3!&1v=mnfjirc1qnpx2)6&14f&kz(!+up'
...
# Celery Settings
CELERY_BROKER_URL = 'redis://127.0.0.1:6379' #default port where redis start working
